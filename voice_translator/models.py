...
class TranslationProcessingTime(BaseModel):
    ...
    speech_to_text = models.FloatField(default=0.0)  # seconds
...
class Translation(BaseModel):
    ...
    original_audio_url = models.CharField(max_length=255, blank=True, null=True, help_text="Original filename of uploaded audio")
